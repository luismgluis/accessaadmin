    ...
    <div className="CalendarIcon">
      ...
      >
        <g xmlns="http://www.w3.org/2000/svg" fill={color}>
          <circle cx="386" cy="210" r="20" data-original="#000000"></circle>
          <path
          ...
          <path
            ...
            data-original="#000000"
          ></path>
          <circle cx="299" cy="210" r="20" data-original="#000000"></circle>
          <circle cx="212" cy="297" r="20" data-original="#000000"></circle>
          <circle cx="125" cy="210" r="20" data-original="#000000"></circle>
          <circle cx="125" cy="297" r="20" data-original="#000000"></circle>
          <circle cx="125" cy="384" r="20" data-original="#000000"></circle>
          <circle cx="212" cy="384" r="20" data-original="#000000"></circle>
          <circle cx="212" cy="210" r="20" data-original="#000000"></circle>
        </g>
      </svg>
    </div>
  );
